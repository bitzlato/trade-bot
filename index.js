...
program
    ...
    .option('--bid-amount [bidAmount]', 'Order amount in USD. Default 1 USD. Can be range, for example 1-10')
    .option('--ask-amount [askAmount]', 'Order amount in USD. Default 1 USD. Can be range, for example 1-10')
...
const config = {
    ...
    bidAmount: program.bidAmount || '1',
    askAmount: program.askAmount || '1',
